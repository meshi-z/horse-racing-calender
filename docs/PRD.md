...
| **バージョン** | v1.20.2 (JRA過去重賞発走時刻マスタ整備および国内過去全重賞確定バックフィルの完了) |
...
28. **Step 28 (Current / v1.20.2): JRA過去重賞発走時刻マスタ整備および国内過去全重賞確定バックフィルの完了 [完了]**
...
29. **Step 29 (Next): フランス重賞発走予定時刻バッチ作成 & 海外主要レース拡張**
    - フランス競馬（France-Galop）の発走予定時刻自動更新バッチ作成および過去分バックフィル。
