...
export const translations = {
  ...
  zh: {
    ...
    filter: {
      ...
      appDocTitle: '分級賽行事曆 - 香港、JRA、NAR、法國、英國、美國重賞賽程',
    ...
    disclaimer: {
      ...
      fanSiteBody: '本服務（分級賽行事曆）為個人開發與營運之非官方愛好者網站。與香港賽馬會（HKJC）、日本中央競馬會（JRA）、地方競馬全國協會（NAR）、法國賽馬會（France Galop）、英國賽馬協會（BHA）、全美純種馬賽馬協會／Equibase（The Jockey Club）及各地方賽馬機構無任何關聯。',
      dataSourceTitle: '資料來源',
      dataSourceBody: '本應用程式刊載之賽事日程、預計開跑時間、參賽條件（場地、途程、參賽資格、負磅等）資料，係取得並整理自 HKJC（香港賽馬會）、JRA（日本中央競馬會）、NAR（地方競馬全國協會）、France Galop（PMU）、英國 BHA（Sporting Life 等）及美國官方 Equibase（The Jockey Club）公開之官方資訊。',
      changesTitle: '賽程變更・建議確認官方公告及免責聲明',
      changesP1: '賽事日程、開跑時間、出賽馬匹、負磅等資訊，可能因惡劣天氣、不可抗力或主辦機構之決定，在未經預告之情況下變更、取消或延期（補賽等）。',
      changesP2: '我們極力維護資訊之準確性與完整性，惟不保證其即時性與絕對完整。投注、現場觀賽或海外遠征前，請務必參閱主辦機構（HKJC、JRA、NAR、France Galop、BHA、Equibase 等）發布之最新官方公告。',
      changesP2Strong: '投注、現場觀賽或海外遠征前，請務必參閱主辦機構（HKJC、JRA、NAR、France Galop、BHA、Equibase 等）發布之最新官方公告。',
      changesP3: '對於因使用或無法使用本服務而產生之任何直接或間接損害或紛爭（包括但不限於投注結果、交通及住宿費用等），本服務之開發者及營運者概不承擔任何責任。',
      rightsTitle: '智慧財產權與商標歸屬',
      rightsBody: '本服務記載之賽事名稱、馬場名稱、主辦機構名稱等智慧財產權與商標，均歸各主辦機構（HKJC、JRA、NAR、France Galop、BHA、The Jockey Club / Equibase 等）及各權利人所有。',
    ...
    footer: {
      copyright: '© 2026 horse-racing-calendar',
      unofficialNotice: '本網站為非官方愛好者網站。最新賽事日程及開跑時間，請務必以各主辦機構（HKJC、JRA、NAR、France Galop、BHA、Equibase 等）官方公告為準。',
    },
    offline: {
