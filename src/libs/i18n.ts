...
export const COURSE_GROUPS: CourseGroup[] = [
  ...
  },
  {
    ...
    courses: [
      ...
      { name: 'サラトガ', label: { ja: 'サラトガ', en: 'Saratoga', fr: 'Saratoga' } },
      { name: 'ベルモントパーク', label: { ja: 'ベルモントパーク', en: 'Belmont Park', fr: 'Belmont Park' } },
      { name: 'アケダクト', label: { ja: 'アケダクト', en: 'Aqueduct', fr: 'Aqueduct' } },
      { name: 'デルマー', label: { ja: 'デルマー', en: 'Del Mar', fr: 'Del Mar' } },
      { name: 'サンタアニタ', label: { ja: 'サンタアニタ', en: 'Santa Anita Park', fr: 'Santa Anita Park' } },
      { name: 'キーンランド', label: { ja: 'キーンランド', en: 'Keeneland', fr: 'Keeneland' } },
      { name: 'ガルフストリームパーク', label: { ja: 'ガルフストリームパーク', en: 'Gulfstream Park', fr: 'Gulfstream Park' } },
      { name: 'ピムリコ', label: { ja: 'ピムリコ', en: 'Pimlico', fr: 'Pimlico' } },
      { name: 'ローレルパーク', label: { ja: 'ローレルパーク', en: 'Laurel Park', fr: 'Laurel Park' } },
      { name: 'モンマスパーク', label: { ja: 'モンマスパーク', en: 'Monmouth Park', fr: 'Monmouth Park' } },
      { name: 'オークローンパーク', label: { ja: 'オークローンパーク', en: 'Oaklawn Park', fr: 'Oaklawn Park' } },
      { name: 'ケンタッキーダウンズ', label: { ja: 'ケンタッキーダウンズ', en: 'Kentucky Downs', fr: 'Kentucky Downs' } },
      { name: 'フェアグラウンズ', label: { ja: 'フェアグラウンズ', en: 'Fair Grounds', fr: 'Fair Grounds' } },
      { name: 'タンパベイダウンズ', label: { ja: 'タンパベイダウンズ', en: 'Tampa Bay Downs', fr: 'Tampa Bay Downs' } },
