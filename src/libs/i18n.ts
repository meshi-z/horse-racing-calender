...
export const translations = {
  ja: {
    ...
    disclaimer: {
      ...
      fanSiteBody: '本サービス（重賞カレンダー）は、個人が開発・運営する非公式のファンサイトです。日本中央競馬会（JRA）、地方競馬全国協会（NAR）、フランスギャロ（France Galop）、各地方競馬主催者（道営、岩手、南関東4場、金沢、愛知、笠松、兵庫、高知、佐賀、ばんえい帯広）およびその他の関連団体とは一切関係ありません。',
      dataSourceTitle: 'データの出典',
      dataSourceBody: '本アプリで掲載しているレース日程、発走予定時刻、出走条件（コース・距離・出走資格・斤量等）のデータは、JRA（日本中央競馬会）公式サイト、NAR（地方競馬全国協会）公式サイト、およびFrance Galop（PMU）公式API等で一般公開されている公式情報（カレンダーファイル、重賞一覧、確定出馬表等）を取得・加工して提供しています。',
      ...
      changesP2: '情報の正確性・網羅性には細心の注意を払っておりますが、リアルタイム性や完全性を保証するものではありません。馬券の購入、現地観戦、遠征等の際は、必ず主催者（JRA・NAR・France Galop等）公式発表の最新情報をご確認ください。',
      changesP2Strong: '馬券の購入、現地観戦、遠征等の際は、必ず主催者（JRA・NAR・France Galop等）公式発表の最新情報をご確認ください。',
      ...
      rightsBody: '本サービスに記載されているレース名、競馬場名、主催団体名等の名称、商標およびロゴ等の知的財産権は、各主催者（JRA、NAR、France Galop、各地方競馬主催者等）ならびに各権利者に帰属します。',
    ...
    footer: {
      ...
      unofficialNotice: '当サイトは非公式ファンサイトです。レース日程・発走時刻等の最新情報は必ず主催者（JRA・NAR・France Galop等）公式発表をご確認ください。',
    },
    offline: {
  ...
  en: {
    ...
    filter: {
      ...
      appDocTitle: 'Graded Races - JRA, NAR & France Galop Graded Races Calendar',
    ...
    disclaimer: {
      ...
      fanSiteBody: 'This service (Graded Races Calendar) is an unofficial, personal fan project and has no affiliation with JRA (Japan Racing Association), NAR (National Association of Racing), France Galop, local racing authorities, or any official racing associations.',
      dataSourceTitle: 'Data Sources',
      dataSourceBody: 'Race schedules, post times, and race conditions (course, distance, eligibility, weight, etc.) published on this app are sourced and processed from publicly accessible official information published by JRA, NAR, and France Galop (PMU).',
      ...
      changesP2: 'While every effort is made to ensure accuracy and completeness, real-time validity and completeness are not guaranteed. When purchasing betting tickets or attending races in person, please always verify official announcements from the organizers (e.g., JRA, NAR, France Galop).',
      changesP2Strong: 'When purchasing betting tickets or attending races in person, please always verify official announcements from the organizers (e.g., JRA, NAR, France Galop).',
      ...
      rightsBody: 'Race names, track names, organization names, trademarks, and logos displayed on this service belong to their respective rights holders (JRA, NAR, France Galop, local authorities, etc.).',
    ...
    footer: {
      copyright: '© 2026 horse-racing-calendar',
      unofficialNotice: 'This is an unofficial fan site. Please always verify the latest race schedules and post times with official organizers (e.g., JRA, NAR, France Galop).',
    },
    offline: {
  ...
  fr: {
    ...
    filter: {
      ...
      appDocTitle: 'Courses de Groupe - Calendrier JRA, NAR & France Galop',
    ...
    disclaimer: {
      ...
      fanSiteBody: "Ce service (Calendrier des courses de groupe) est un projet personnel non officiel. Il n'est affilié d'aucune manière à la JRA, à la NAR, à France Galop ou à tout autre organisme de courses officiel.",
      dataSourceTitle: 'Sources des données',
      dataSourceBody: 'Les calendriers de courses, horaires de départ et conditions de course publiés proviennent des données publiques officielles publiées par la JRA, la NAR et France Galop (PMU).',
      ...
      changesP2: "Bien que le plus grand soin soit apporté à l'exactitude des informations, leur temps réel et leur exhaustivité ne sont pas garantis. Veuillez toujours vérifier les annonces officielles des organisateurs (JRA, NAR, France Galop).",
      changesP2Strong: 'Veuillez toujours vérifier les annonces officielles des organisateurs (JRA, NAR, France Galop).',
      ...
      rightsBody: "Les noms de courses, d'hippodromes et d'organisations, ainsi que les marques et logos affichés, appartiennent à leurs titulaires de droits respectifs.",
    ...
    footer: {
      copyright: '© 2026 horse-racing-calendar',
      unofficialNotice: 'Ce site est un projet de fans non officiel. Veuillez toujours vous référer aux annonces officielles des organisateurs (JRA, NAR, France Galop) pour les informations les plus récentes.',
    },
    offline: {
